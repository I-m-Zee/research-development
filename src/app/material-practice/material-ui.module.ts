...
const MATERIALUIMODUELS = [
  ...
  MatSortModule, MatPaginatorModule, MatBottomSheetModule, MatRippleModule,
  MatBadgeModule, MatTreeModule, MatDividerModule, MatNativeDateModule,
  CdkAccordionModule, BidiModule, ClipboardModule, ContentContainerComponentHarness,
  DialogModule, DragDropModule, LayoutModule, CdkListboxModule,
  CdkMenuModule, ObserversModule, OverlayModule, PlatformModule, 
  PortalModule, ScrollingModule, CdkStepperModule, CdkTableModule,
  TextFieldModule, CdkTreeModule
]
@NgModule({
  imports: [MATERIALUIMODUELS],
  exports: [MATERIALUIMODUELS]
})
